    ...
    <>
      <div className="drawer lg:drawer-open max-h-screen">
        ...
        <div className="drawer-content flex flex-col">
          <div className="navbar justify-between md:justify-between bg-base-300 w-full pl-10">
            ...
            <div className="flex items-center justify-around md:justify-between w-full lg:hidden px-2">
              <Link
                href="/admin/dashboard"
                className="flex h-16 w-52 flex-row items-center justify-center space-x-3 md:justify-start md:px-6"
              >
                <span className="h-7 w-7 rounded-lg bg-base-200">
                  <IconTypography size={28} className="text-base-content" />
                </span>
